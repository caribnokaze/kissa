...
<body>
  ...
  <main class="main">
    ...
    <div class="contact">
      <h2>お問い合わせフォーム</h2>
      <form action="http://itsumogenki.biz/contact.php" method="post">
        <dl class="form-area">
        ...
        <p class="confirm-text"><span>ご入力内容をご確認の上、お間違いがなければ</span><span>【送信】ボタンを押してください</span></p>
        <button class="submit-button" type="submit" value="送信">送信</button>
      </form>
    </div>
  </main>
